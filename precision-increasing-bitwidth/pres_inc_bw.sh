...
./precision_increasing_bitwidth.out 10 > pres_bw_10.log 

cat header.txt pres_bw_5.log pres_bw_6.log pres_bw_7.log pres_bw_8.log pres_bw_9.log pres_bw_10.log | column -ts,
